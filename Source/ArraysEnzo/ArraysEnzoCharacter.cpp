...
void AArraysEnzoCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AArraysEnzoCharacter::Move);
...
void AArraysEnzoCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AArraysEnzoCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
